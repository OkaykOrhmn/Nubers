...
import static com.example.nubers.util.IabHelper.IABHELPER_MISSING_TOKEN;
import static com.example.nubers.util.IabHelper.IABHELPER_REMOTE_EXCEPTION;
import static com.example.nubers.util.IabHelper.IABHELPER_SEND_INTENT_FAILED;
import static com.example.nubers.util.IabHelper.IABHELPER_SUBSCRIPTIONS_NOT_AVAILABLE;
import static com.example.nubers.util.IabHelper.ITEM_TYPE_INAPP;
import static com.example.nubers.util.IabHelper.ITEM_TYPE_SUBS;
import static com.example.nubers.util.IabHelper.RESPONSE_BUY_INTENT;
