package com.example.nubers.util;

import static com.example.nubers.util.IabHelper.BILLING_RESPONSE_RESULT_OK;
import static com.example.nubers.util.IabHelper.IABHELPER_BAD_RESPONSE;
import static com.example.nubers.util.IabHelper.IABHELPER_UNKNOWN_ERROR;
import static com.example.nubers.util.IabHelper.IABHELPER_UNKNOWN_PURCHASE_RESPONSE;
import static com.example.nubers.util.IabHelper.IABHELPER_USER_CANCELLED;
import static com.example.nubers.util.IabHelper.IABHELPER_VERIFICATION_FAILED;
import static com.example.nubers.util.IabHelper.RESPONSE_CODE;
import static com.example.nubers.util.IabHelper.RESPONSE_INAPP_PURCHASE_DATA;
import static com.example.nubers.util.IabHelper.RESPONSE_INAPP_SIGNATURE;
import static com.example.nubers.util.IabHelper.getResponseDesc;
...
import com.example.nubers.util.communication.BillingSupportCommunication;
import com.example.nubers.util.communication.OnConnectListener;
